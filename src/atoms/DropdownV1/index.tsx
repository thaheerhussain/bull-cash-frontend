  ...
  return (
    <div ref={dropdownRef} className={`relative  ${className}`}>
      <button
        ...
        className="text-gray1 relative  appearance-none border shadow-boxShadow5 border-borderv1 rounded-full px-4 focus:outline-none font-medium  text-sm  py-2.5 text-center inline-flex justify-between items-center w-full"
        type="button">
      ...
      <div
        ...
        } absolute z-50 bg-white rounded divide-y divide-gray-100 shadow w-full`}>
        <ul
