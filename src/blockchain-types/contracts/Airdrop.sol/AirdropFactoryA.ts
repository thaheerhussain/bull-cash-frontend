...
export declare namespace AirdropFactoryA {
...
export interface AirdropFactoryAInterface extends utils.Interface {
  functions: {
  ...
  encodeFunctionData(
    ...
    values: [
      AirdropFactoryA.SocialStruct,
      AirdropFactoryA.VestingStruct,
...
export interface AirdropFactoryA extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: AirdropFactoryAInterface;
  ...
  functions: {
    ...
    createAirdrop(
      _social: AirdropFactoryA.SocialStruct,
      vesting: AirdropFactoryA.VestingStruct,
